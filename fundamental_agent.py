...
from world_knowledge import BUSINESS_WORLD_KNOWLEDGE, get_business_intelligence
...
def _load_stockapi_industry_map():
    ...
    cache_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), ".cache", "stockapi_industry.json")
