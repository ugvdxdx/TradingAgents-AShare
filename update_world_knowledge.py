...
WK_MD_PATH = os.path.join(SCRIPT_DIR, "_world_knowledge_2026_06.md")
WK_PY_PATH = os.path.join(SCRIPT_DIR, "world_knowledge.py")
...
def collect_attribution_knowledge() -> str:
    ...
    """
    attr_path = os.path.join(SCRIPT_DIR, ".mispriced_attribution_cache.json")
